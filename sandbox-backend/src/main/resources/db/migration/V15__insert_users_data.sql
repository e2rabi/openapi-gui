...
VALUES
    ...
    ('bwhite', 'Bob', 'White', 'bwhite@example.com',false, 'password3', '555-9101', '789 Oak St', TRUE, TRUE, FALSE),
    ('cjohnson', 'Carol', 'Johnson', 'cjohnson@example.com',false, 'password4', '555-1122', '321 Pine St', FALSE, TRUE, TRUE),
    ('dlee', 'David', 'Lee', 'dlee@example.com',false, 'password5', '555-3344', '654 Maple St', TRUE, TRUE, TRUE);